 ...
 * 1. Create one package with name homework_week5.calculate
...
public class Calculator {
    ...
    // Instance Method with params to homework_week5.calculate result based on input symbol using switch statement
